...
# 
  test "testSimpleDiscounts" do
    ...
    assert 8 * 4 * 0.85 == Potter.price([0, 1, 2, 4])
    assert 8 * 5 * 0.8 == Potter.price([0, 1, 2, 3, 4])
  end
  
  test "testSeveralDiscounts" do
    assert 8 + (8 * 2 * 0.95) == Potter.price([0, 0, 1])
    assert 2 * (8 * 2 * 0.95) == Potter.price([0, 0, 1, 1])
    assert (8 * 4 * 0.85) + (8 * 2 * 0.95) == Potter.price([0, 0, 1, 2, 2, 3])
    assert 8 + (8 * 5 * 0.8) == Potter.price([0, 1, 1, 2, 3, 4])
  end
  
  # test "testEdgeCases" do
  #   assert 2 * (8 * 4 * 0.85) == Potter.price([0, 0, 1, 1, 2, 2, 3, 4])
  #   assert 3 * (8 * 5 * 0.8) + 2 * (8 * 4 * 0.8) == 
