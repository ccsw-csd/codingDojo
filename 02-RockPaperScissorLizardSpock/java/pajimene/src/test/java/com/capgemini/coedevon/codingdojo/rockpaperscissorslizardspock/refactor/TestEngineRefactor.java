package com.capgemini.coedevon.codingdojo.rockpaperscissorslizardspock.refactor;

import org.junit.Assert;
import org.junit.Test;

import com.capgemini.coedevon.codingdojo.rockpaperscissorslizardspock.refactor.RuleEngineRefactor.Move;
import com.capgemini.coedevon.codingdojo.rockpaperscissorslizardspock.refactor.RuleEngineRefactor.Result;

/**
 * jUnit Test RockPaperScissorsLizardSpock
 */
public class TestEngineRefactor {
  ...
  private void assertMovesReturn(Move movePlayer1, Move movePlayer2, Result result) {
    ...
    RuleEngineRefactor ruleEngine = new RuleEngineRefactor();
