...
import com.capgemini.coedevon.codingdojo.rockpaperscissorslizardspock.refactor_subclasses_enum.RuleEngineRefactorSubclassesEnum.Result;

/**
 * jUnit Test RockPaperScissorsLizardSpock
 */
public class TestEngineRefactorSubclassesEnum {
  ...
  private void assertMovesReturn(Move movePlayer1, Move movePlayer2, Result result) {
    ...
    RuleEngineRefactorSubclassesEnum ruleEngine = new RuleEngineRefactorSubclassesEnum();
